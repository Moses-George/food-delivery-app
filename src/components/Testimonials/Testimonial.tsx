...
const Testimonial = () => {
    ...
    return (
        <div className="flex sm:flex-col-reverse items-center  gap-x-5 mb-4 w-2/3 md:w-4/5 sm:w-full sm:px-5 mx-auto">
            ...
            <div className=" flex bg-indigo-100 text-gray-800 h-60 p-2 rounded-lg shadow-sm mb-2 relative">
                ...
                <div className="absolute right-0 top-1/2 transform translate-x-1/2 rotate-45 w-12 sm:w-8 h-12 sm:h-8 bg-indigo-100"></div>
            </div>
        </div>
    )
}
