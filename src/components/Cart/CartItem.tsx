        ...
        <div className="flex sm:flex-col sm:gap-y-4 py-5 justify-between w-full gap-x-16 border-b-2">
            ...
            <div className="flex items-center justify-between gap-x-5">
                <div className="flex items-center gap-x-3 sm:gap-x-4">
                    <button className="p-2 rounded-lg bg-lightest-peach"> <AiOutlineMinus style={{ color: "#DA0463", fontSize: "13px" }} /> </button>
                    <p className="text-dark-blue text-md font-semibold">2</p>
                    <button className="p-2 rounded-lg bg-lightest-peach"><FaPlus style={{ color: "#DA0463", fontSize: "13px" }} /> </button>
                </div>
                <div className="flex items-center gap-x-3">
                    <h3 className="font-semibold text-xl text-dark-gray">$12.40</h3>
                    <AiOutlineDelete style={{ color: "#DA0463", fontSize: "20px" }} />
                </div>
            </div>
        </div>
    )
